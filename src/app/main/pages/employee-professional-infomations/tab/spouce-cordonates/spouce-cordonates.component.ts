...
@Component({
    selector: 'app-spouce-cordonates',
    templateUrl: './spouce-cordonates.component.html',
    styleUrls: ['./spouce-cordonates.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class SpouceCordonatesComponent implements OnInit {
    @Input() user: any;
    phoneControl: any;
    ...
    getCommune(code) {
        return code ? this.refService.getLocalComune(code).name : '/';
    }
    getWilaya(code) {
        return code ? this.refService.getLocalWilaya(code).name : '/';
    }
